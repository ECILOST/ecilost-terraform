...
locals {
  ...
  # Bajo demanda: en reposo no cuesta, pero los consumidores AMQP y los schedulers de
  # auction no corren. Para una prueba completa: terraform apply -var min_replicas=1.
